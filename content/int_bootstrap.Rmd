---
title: "Iteration/Simulation/Bootstrap"
...
writing a fxn after creating vector of top 100 names that spits out largest percentage drops, need to calc all percentage drops and then arrange so that the largest one is first

top100names <- babynames
