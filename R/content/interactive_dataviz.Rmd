...
library(ggplot2)
library(plotly)
food_data <- read.csv("/Users/fran-pellegrino/Library/CloudStorage/OneDrive-LoyolaUniversityChicago/DSCI101/DSCI_Whalen/data/food_inspections.csv")
view(food_data)

# scatter plot
plot_ly(food_data, x = Inspection.Type, y = , mode = "markers", type = "scatter", marker = list(size = 10)) %>%
  layout(title = "Pass Rate by Month", xaxis = list(title = "Pass Rate"), yaxis = list(title = "Inspection Type"))
